...
Register as of 2026-07-31 post-sweep (9): 071247 (permanent), 085502,
012337 (below floor but chain-anchored, exemption holds), 045426, 084444,
065940, 102026, 145024 (tailward confirmed, does not flip), 145708.
...
per JSONL), 123020 (negative high, manual_promoted_review, the
class-definition exhibit — NOT pending).
...
- `label_source`: auto_rule | manual_unanimous | manual_promoted_review |
  ...
  flux_z_floor_rule; suffix `+chain_evidence` flags labels whose evidence
  included chain features (circularity audit for model A).
